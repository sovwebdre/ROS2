...
int8_t L_FORW = 18;
int8_t L_BACK = 5;
int8_t L_enablePin = 4;
int8_t L_encoderPin1 = 32;  //Encoder Output of pin1 must connected with intreput pin of Esp32.
int8_t L_encoderPin2 = 33;
//right wheel
int8_t R_FORW = 16;
int8_t R_BACK = 17;
int8_t R_enablePin = 0;
